package com.kumhomarine.chartplotter.presentation.utils
...
object ChartPlotterHelpers {
    ...
    fun calculateDistance(lat1: Double, lon1: Double, lat2: Double, lon2: Double): Double {
        return com.kumhomarine.chartplotter.utils.DistanceCalculator.calculateGeographicDistance(
            lat1,
            lon1,
            lat2,
            lon2
    ...
    fun calculateScreenDistance(latLng1: LatLng, latLng2: LatLng, map: MapLibreMap): Double {
        return com.kumhomarine.chartplotter.utils.DistanceCalculator.calculateScreenDistance(
            latLng1,
            latLng2,
            map
        )
