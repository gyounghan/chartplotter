...
import com.kumhomarine.chartplotter.presentation.modules.ais.components.VesselCard
import com.kumhomarine.chartplotter.presentation.modules.ais.components.VesselLocationDialog
...
import com.kumhomarine.chartplotter.presentation.modules.ais.models.SortOption
...
private fun sortVessels(
    ...
    val sorted = when (sortBy) {
        ...
        SortOption.RISK -> {
            val riskOrder = mapOf(
                com.kumhomarine.chartplotter.domain.entities.RiskLevel.CRITICAL to 0,
                com.kumhomarine.chartplotter.domain.entities.RiskLevel.WARNING to 1,
                com.kumhomarine.chartplotter.domain.entities.RiskLevel.SAFE to 2
            )
            if (ascending) {
