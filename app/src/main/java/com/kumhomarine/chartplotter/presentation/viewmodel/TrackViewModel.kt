...
class TrackViewModel(
    ...
    private val onAllRecordingStopped: (() -> Unit)? = null
) : ViewModel() {
    ...
    fun stopTrackRecording(trackId: String? = null) {
        ...
        val wasLastRecordingTrack = currentTrackUiState.recordingTracks.size == 1

        viewModelScope.launch {
            trackRepository.setTrackRecording(targetTrackId, false)
            if (wasLastRecordingTrack) {
                onAllRecordingStopped?.invoke()
            }
        }
    ...
    companion object {
        fun provideFactory(
            ...
            onAllRecordingStopped: (() -> Unit)? = null
            ...
            return object : ViewModelProvider.Factory {
                ...
                override fun <T : ViewModel> create(modelClass: Class<T>): T {
                    ...
                    return TrackViewModel(
                        ...
                        calculateDistanceUseCase = calculateDistanceUseCase,
                        onAllRecordingStopped = onAllRecordingStopped
                    ) as T
                }
            }
        }
