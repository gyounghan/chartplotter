package com.marineplay.chartplotter.service
...
class AISForegroundService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.marineplay.chartplotter.AIS_SERVICE_START"
        const val ACTION_STOP = "com.marineplay.chartplotter.AIS_SERVICE_STOP"
    }
}
